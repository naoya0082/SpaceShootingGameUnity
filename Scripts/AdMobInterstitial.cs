...
public class AdMobInterstitial : MonoBehaviour
{
    ...
    //private string _adUnitId = "ca-app-pub-8673262984895359/1356138024";      // リリース用広告

#elif UNITY_IPHONE
    private string _adUnitId = "ca-app-pub-3940256099942544/4411468910";      // テスト広告
    //private string _adUnitId = "ca-app-pub-8673262984895359/9713187929";      // リリース用広告
  ...
  private string _adUnitId = "unused";
    ...
    private void RegisterEventHandlers(InterstitialAd ad)
    {
        ...
        ad.OnAdFullScreenContentOpened += () =>
        {
            ...
            //sceneTransitionManager.LoadToScene("Select");
